                  ...
                  <div className="mt-6 pt-6 border-t border-border">
                    ...
                    <div className="flex gap-4 justify-center">
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="w-12 h-12 bg-primary/20 rounded-lg flex items-center justify-center hover:bg-primary/30 transition-smooth glow-purple"
